...
export default function Welcome() {
  ...
  const programs = [
    ...
    { name: 'দ্বিতীয় - পঞ্চম', duration: '৪ বছর', age: '৬-১০ বছর', icon: GraduationCap },
    { name: 'ষষ্ঠ - অষ্টম', duration: '৩ বছর', age: '১০-১৩ বছর', icon: Award },
    { name: 'নবম - দশম', duration: '২ বছর', age: '১৩-১৫ বছর', icon: Trophy },
  ];
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 text-white bengali-font">
        {/* Header */}
        <motion.header
          initial={{ y: -100 }}
          animate={{ y: 0 }}
            ...
            <div className="flex justify-between items-center py-4">
              ...
              >
                <div className="relative">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/50 group-hover:shadow-blue-500/70 transition-all">
              ...
              <div className="flex items-center gap-4">
                <motion.a
                  ...
                  initial={{ opacity: 0, x: 20 }}
                  animate={{ opacity: 1, x: 0 }}
                  className="hidden md:flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full hover:shadow-lg hover:shadow-blue-500/50 transition-all font-medium"
                >
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="px-4 py-4 space-y-3">
                ...
                <a
                  href="tel:01713758424"
                  className="flex items-center justify-center gap-2 w-full px-6 py-2.5 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full font-medium"
                >
                  <Phone className="w-4 h-4" />
                  <span className="text-sm">যোগাযোগ করুন</span>
                </a>
        ...
        <section id="home" className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden">
          {/* Background Pattern */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.1)_0%,transparent_65%)] pointer-events-none" />
              ...
              >
                ...
                <div className="space-y-4">
                  <h1 className="text-5xl md:text-7xl font-bold leading-tight">
                    <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent heading-font">
                      মৌসুমী
                    </span>
                    <br />
                ...
                <div className="flex flex-wrap gap-4">
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="group px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl font-medium flex items-center gap-2 hover:shadow-xl hover:shadow-blue-500/50 transition-all"
                  >
                    ভর্তির আবেদন করুন
                  ...
                  <motion.a
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-4 bg-white/5 backdrop-blur-sm rounded-xl font-medium border border-white/10 hover:bg-white/10 transition-all"
                  >
                    আরও জানুন
                  </motion.a>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8">
                  {achievements.map((stat, index) => (
                    ...
                    >
                      <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-xl mb-2 group-hover:scale-110 transition-transform">
                ...
                <div className="relative">
                  ...
                  <div className="relative w-full aspect-square">
                    <motion.div
                      ...
                      className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-600/20 blur-3xl"
                    />
                    <div className="relative w-full h-full rounded-full bg-white/5 backdrop-blur-sm border border-white/10 flex items-center justify-center">
                      <div className="w-4/5 h-4/5 rounded-full bg-gradient-to-br from-blue-500/30 to-purple-600/30 backdrop-blur-sm border border-white/10 flex items-center justify-center">
                        <div className="w-3/4 h-3/4 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-2xl shadow-blue-500/50">
                  ...
                  {/* Floating Icons */}
                  {[
                    { Icon: Trophy, position: 'top-10 -left-10', delay: 0 },
                    { Icon: Award, position: 'top-20 -right-10', delay: 0.2 },
                    { Icon: Star, position: 'bottom-20 -left-10', delay: 0.4 },
                    { Icon: GraduationCap, position: 'bottom-10 -right-10', delay: 0.6 },
                  ].map((item, index) => (
                    <motion.div
                      key={index}
                      ...
                      className={`absolute ${item.position} w-16 h-16 bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center border border-white/20 shadow-xl`}
                    >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                কেন <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">আমাদের</span>{' '}
                বেছে নেবেন?
              </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  transition={{ delay: index * 0.1 }}
                  whileHover={{ y: -10 }}
                  className="group relative bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-white/20 transition-all cursor-pointer overflow-hidden"
                >
                  ...
                  <div className="relative mt-4 flex items-center text-blue-400 text-sm font-medium group-hover:gap-2 transition-all">
                    <span>বিস্তারিত</span>
        ...
        <section id="academic" className="py-20 relative overflow-hidden">
          {/* Background Pattern */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(147,51,234,0.1)_0%,transparent_65%)] pointer-events-none" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">একাডেমিক</span>{' '}
                কার্যক্রম
              </h2>
              <p className="text-gray-400 text-lg">প্লে গ্রুপ থেকে দশম শ্রেণি পর্যন্ত সম্পূর্ণ শিক্ষা কার্যক্রম</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {programs.map((program, index) => (
                <motion.div
                  ...
                  transition={{ delay: index * 0.1 }}
                  whileHover={{ scale: 1.05 }}
                  className="relative group bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-purple-500/50 transition-all cursor-pointer overflow-hidden"
                >
                  {/* Gradient Border Effect */}
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-500/0 to-pink-500/0 group-hover:from-purple-500/20 group-hover:to-pink-500/20 transition-all rounded-2xl" />
                  ...
                  <div className="relative flex items-start justify-between mb-4">
                    ...
                    <div className="px-3 py-1 bg-purple-500/20 rounded-full text-sm border border-purple-500/30">
                      {program.duration}
                    </div>
                  </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="mt-6 w-full py-4 bg-white/5 backdrop-blur-sm rounded-xl font-medium border border-white/10 hover:bg-white/10 transition-all"
                >
                  সকল নোটিশ দেখুন
                </motion.button>
              </motion.div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <a
                          ...
                          className="font-medium hover:text-pink-400 transition-colors text-sm"
                        >
                          info@mousumi.edu.bd
                        </a>
                      </div>
        ...
        <section id="gallery" className="py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                আমাদের <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">ক্যাম্পাস</span>
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {[
                { title: 'ক্লাসরুম', emoji: '🏫' },
                { title: 'লাইব্রেরি', emoji: '📚' },
                { title: 'ল্যাবরেটরি', emoji: '🔬' },
                { title: 'খেলার মাঠ', emoji: '⚽' },
                { title: 'কম্পিউটার ল্যাব', emoji: '💻' },
                { title: 'অডিটোরিয়াম', emoji: '🎭' },
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, scale: 0.9 }}
                  ...
                  className="relative group aspect-square bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 hover:border-blue-500/50 transition-all cursor-pointer"
                >
            ...
            >
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl font-medium hover:shadow-xl hover:shadow-blue-500/50 transition-all inline-flex items-center gap-2"
              >
        ...
        <section id="contact" className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-blue-500/20"
            >
              <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    {[
                      { Icon: Phone, label: 'ফোন করুন', value: '০১৭১৩-৭৫৮৪২৪', href: 'tel:01713758424', color: 'from-blue-500 to-cyan-500' },
                      { Icon: MapPin, label: 'ঠিকানা', value: 'উকিলপাড়া, নওগাঁ', color: 'from-purple-500 to-pink-500' },
                      { Icon: Mail, label: 'ইমেইল', value: 'info@mousumi.edu.bd', href: 'mailto:info@mousumi.edu.bd', color: 'from-amber-500 to-orange-500' },
                    ].map((item, index) => (
                      <motion.div
                        key={index}
                        whileHover={{ x: 10 }}
                      ...
                      >
                        ...
                        <div>
                          ...
                          {item.href ? (
                            <a href={item.href} className="text-lg font-medium hover:text-blue-400 transition-colors">
                              {item.value}
                            </a>
                          ) : (
                ...
                <div>
                  <form className="space-y-6">
                    <div>
                      ...
                      <input
                        type="text"
                        className="w-full px-4 py-3 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 focus:border-blue-500 focus:outline-none transition-colors text-white placeholder:text-gray-500"
                    ...
                    <div>
                      ...
                      <textarea
                        rows={4}
                        className="w-full px-4 py-3 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 focus:border-blue-500 focus:outline-none transition-colors text-white placeholder:text-gray-500 resize-none"
                    ...
                    <motion.button
                      ...
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="w-full py-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl font-medium hover:shadow-xl hover:shadow-blue-500/50 transition-all"
                    >
                      বার্তা পাঠান
                    </motion.button>
                  </form>
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  ...
                  <li>
                    <a href="tel:01713758424" className="hover:text-blue-400 transition-colors">
                      ০১৭১৩-৭৫৮৪২৪
                    </a>
                  </li>
                  <li>
                    <a href="mailto:info@mousumi.edu.bd" className="hover:text-blue-400 transition-colors">
                      info@mousumi.edu.bd
                    </a>
                  </li>
                </ul>
              ...
              <div className="flex gap-4">
                {[
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-10 h-10 bg-white/5 backdrop-blur-sm rounded-lg flex items-center justify-center border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all"
                  >
