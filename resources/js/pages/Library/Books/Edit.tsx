...
export default function Edit({ book }: EditProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        quantity: book.total_copies?.toString() || '0',
        available_quantity: book.available_copies?.toString() || '0',
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        router.put(`/books/${book.id}`, formData, {
            onError: (errors) => {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setFormData({ ...formData, status: e.target.value as 'available' | 'unavailable' | 'damaged' })}
