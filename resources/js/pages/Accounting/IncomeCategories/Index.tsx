            ...
            <div className="space-y-4">
                <div className="flex flex-wrap items-center justify-between gap-2">
                    <div>
                        ...
                        <p className="text-xs text-emerald-700/80 mt-0.5">Categories for income transactions</p>
                    </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    <div className="bg-white rounded-lg border border-emerald-100 border-l-4 border-l-emerald-500 shadow-sm px-4 py-3 flex items-center gap-3">
                        <div className="p-1.5 rounded bg-emerald-100 text-emerald-700"><TrendingUp className="w-4 h-4" /></div>
                    ...
                    <div className="bg-white rounded-lg border border-emerald-100 shadow-sm px-4 py-3 flex items-center gap-3">
                        <div className="p-1.5 rounded bg-green-100 text-green-700"><TrendingUp className="w-4 h-4" /></div>
                    ...
                    <div className="overflow-x-auto">
                        ...
                        {categories.length === 0 && (
                            <div className="text-center py-12">
                                ...
                                <p className="text-sm text-gray-500">No income categories found</p>
                            </div>
                        )}
                    </div>
                </div>
