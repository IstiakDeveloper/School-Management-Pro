...
function route(name: string, params?: any): string {
    const routes: Record<string, string> = {
        ...
        'accounting.investors.update': '/accounting/investors',
    };
...
export default function Edit({ investor }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('accounting.investors.update', investor.id));
    };
            ...
            <div className="py-12">
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-3xl font-bold text-gray-800">Edit Investor</h2>
                        <Link
