...
import { Exam, AcademicYear, SchoolClass } from '@/types/exam';
...
export default function Edit({ exam, academicYears, classes }: EditProps) {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        router.put(`/exams/${exam.id}`, formData, {
            onError: (errors) => {
